...
from jobquest.exception import LinkedInException
from jobquest.linkedin.constant import headers
from jobquest.linkedin.util import (
    is_job_remote,
    job_type_code,
    parse_job_type,
    parse_job_level,
    ...
    def __init__(
        ...
        if SCRAPLING_AVAILABLE:
            self.session = create_stealth_session(
                proxies=self.proxies, ca_cert=ca_cert, retries=3, retry_delay=5,
                clear_cookies=True,
            )
        else:
